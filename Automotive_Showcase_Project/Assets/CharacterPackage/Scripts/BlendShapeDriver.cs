...
public class BlendShapeDriver : MonoBehaviour
{
    ...
    public BlendShape Afraid = new BlendShape("WinkL", 0);
    public BlendShape Angry = new BlendShape("WinkR", 1);
    public BlendShape Blink_Half = new BlendShape("AngryL", 2);
    public BlendShape Blink = new BlendShape("AngryR", 3);
    public BlendShape Concerned = new BlendShape("ConcernedR", 4);
    public BlendShape Confused = new BlendShape("ConcernedL", 5);
    public BlendShape Excited = new BlendShape("Scared", 6);
    public BlendShape Focused = new BlendShape("EyebrowL", 7);
    public BlendShape Happy = new BlendShape("EyebrowR", 8);
    public BlendShape Sad = new BlendShape("CheekL", 9);
    public BlendShape Satisfied = new BlendShape("CheekR", 10);
    public BlendShape Surprised = new BlendShape("SquintL", 11);
    public BlendShape Twelve = new BlendShape("SquintR", 12);
